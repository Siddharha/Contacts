...
class AppUtil {
    lateinit var swipeActionCallback: SwipeActionCallback
    companion object{
        ...
        val simpleItemTouchCallback =
            object :
                ...
                override fun onMove(
                    ...
                    swipeActionCallback.onMove(true)
                    return false
                }
                ...
                override fun onSwiped(
                    ...
                    if (direction == ItemTouchHelper.LEFT) {
                        ...
                        swipeActionCallback.onLeftSwipe(true,position)

                    } else {
                        swipeActionCallback.onRightSwipe(true,position)
